...
export const ATTACHMENTS: Record<string, Attachment> = {
  ...
  optic_6x_marksman: {
    id: "optic_6x_marksman",
    name: "6× Marksman Scope",
    slot: "optic",
  ...
  optic_10x_longrange: {
    id: "optic_10x_longrange",
    name: "10× Long Range Scope",
    slot: "optic",
    compatibleWith: ["trg22"],
    price: 1900,
    zoom: 10.0,
  ...
  optic_12x_longrange: {
    id: "optic_12x_longrange",
    name: "12× Long Range Scope",
    slot: "optic",
    compatibleWith: ["trg22"],
    price: 2200,
    zoom: 12.0,
