...
export const WEAPONS: Record<string, Weapon> = {
  ...
  sar21: {
    ...
    reloadTimeSec: 2.4,
    adsTimeSec: 0.25,
    falloff: { startM: 40, endM: 120, minMultiplier: 0.5 },
    recoil: { vertical: 1.2, horizontal: 0.4, recovery: 6 },
    spread: { hip: 3.0, ads: 0.4, movePenalty: 1.2 },
    moveSpeedMult: 1.0,
    isProjectile: false,
    price: 0,
  ...
  br18: {
    ...
    reloadTimeSec: 2.3,
    adsTimeSec: 0.24,
    falloff: { startM: 45, endM: 130, minMultiplier: 0.5 },
    recoil: { vertical: 1.3, horizontal: 0.5, recovery: 6.5 },
    spread: { hip: 3.2, ads: 0.35, movePenalty: 1.2 },
    moveSpeedMult: 1.0,
    isProjectile: false,
    price: 2500,
  ...
  p30: {
    ...
    reloadTimeSec: 1.6,
    adsTimeSec: 0.18,
    falloff: { startM: 15, endM: 45, minMultiplier: 0.4 },
  ...
  m110: {
    ...
    reloadTimeSec: 2.8,
    adsTimeSec: 0.34,
    falloff: { startM: 80, endM: 250, minMultiplier: 0.7 },
  ...
  trg22: {
    ...
    reloadTimeSec: 3.2,
    adsTimeSec: 0.45,
    falloff: { startM: 150, endM: 400, minMultiplier: 0.85 },
  ...
  fnmag: {
    ...
    reloadTimeSec: 6.5,
    adsTimeSec: 0.5,
    falloff: { startM: 60, endM: 180, minMultiplier: 0.6 },
